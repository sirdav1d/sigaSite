...
export default function Container(props: ContainerProps) {
	return (
		<div
			...
			<div
				data-role={props.role}
				className='max-w-7xl data-[role=hero]:mt-40 h-fit data-[role=faq]:max-w-4xl  data-[role=faq]:h-full  data-[role=faq]:items-center flex 2xl:mx-auto flex-col data-[role=hero]:items-center justify-center items-start w-full mx-5'>
				{props.children}
			</div>
		</div>
	);
